...
client = client.Client(host="localhost", port=61297, buffer_size=4096,
                       receive_timeout=1000, print_incoming_messages=True, print_sent_messages=True,
                       kernel="linear", x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test,
                       learning_rate=0.000001, lambda_parameter=0.1, iterations=750)
